...
<template>
  <div class="header">
    <div class="container">
      ...
      <div class="form">
        ...
        <button class="btn" @click="addTask">add new tasks</button>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <h2>
      <span>Todo List</span>
      <span class="mask-num">{{ getList(false).length }}</span>
    </h2>
    <ul class="mask-list">
      <li v-for="task in getList(false)" :key="task.id">
        <ListItem
          :id="task.id"
          :title="task.title"
          :isDone="task.isDone"
    ...
    <h2>
      <span>Done</span>
      <span class="mask-num">{{ this.getList(true).length }}</span>
    </h2>
    <ul class="mask-list complete-list">
      <li v-for="task in getList(true)" :key="task.id">
        <ListItem
          :id="task.id"
          :title="task.title"
          :isDone="task.isDone"
