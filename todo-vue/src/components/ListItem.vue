...
export default {
  ...
  emits: ["removeTask", "doCheck"],
};
</script>

<template>
  <input type="checkbox" v-model="this.isDone" v-on:change="$emit('doCheck', this.id)">
  <span>{{ this.title }}</span>
  <button class="btn-remove" @click="$emit('removeTask', this.id)">Remove</button>
</template>
